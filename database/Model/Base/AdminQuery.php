 ...
 * @method     ChildAdmin findOneByFullname(string $fullname) Return the first ChildAdmin filtered by the fullname column
 ...
 * @method     ChildAdmin[]|ObjectCollection findByFullname(string $fullname) Return ChildAdmin objects filtered by the fullname column
...
abstract class AdminQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Admin', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, username, fullname, email, password FROM admin WHERE id = :p0';
        try {
    ...
    public function filterByFullname($fullname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_FULLNAME, $fullname, $comparison);
    }
