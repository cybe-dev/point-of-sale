 ...
 * @method     ChildProduct[]|ObjectCollection findByStock(int $stock) Return ChildProduct objects filtered by the stock column
...
abstract class ProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, price, stock FROM product WHERE id = :p0';
        try {
