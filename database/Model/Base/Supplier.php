...
abstract class Supplier implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\SupplierTableMap';
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Supplier The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Supplier (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Supplier Clone of current object.
     * @throws PropelException
     */
