...
class AdminTableMap extends TableMap
{
     ...
     */
    const COL_FULLNAME = 'admin.fullname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Username', 'Fullname', 'Email', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'username', 'fullname', 'email', 'password', ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_USERNAME, AdminTableMap::COL_FULLNAME, AdminTableMap::COL_EMAIL, AdminTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'fullname', 'email', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Username' => 1, 'Fullname' => 2, 'Email' => 3, 'Password' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'username' => 1, 'fullname' => 2, 'email' => 3, 'password' => 4, ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_USERNAME => 1, AdminTableMap::COL_FULLNAME => 2, AdminTableMap::COL_EMAIL => 3, AdminTableMap::COL_PASSWORD => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'fullname' => 2, 'email' => 3, 'password' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
