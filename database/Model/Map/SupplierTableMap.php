...
class SupplierTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.SupplierTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Supplier';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Supplier';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_CAMELNAME     => array('id', 'name', 'address', 'phone', ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_ID, SupplierTableMap::COL_NAME, SupplierTableMap::COL_ADDRESS, SupplierTableMap::COL_PHONE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'address' => 2, 'phone' => 3, ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_ID => 0, SupplierTableMap::COL_NAME => 1, SupplierTableMap::COL_ADDRESS => 2, SupplierTableMap::COL_PHONE => 3, ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'supplier.name' => 'NAME',
        'SupplierTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'name' => 'NAME',
        'supplier.name' => 'NAME',
        'Address' => 'ADDRESS',
        ...
        'phone' => 'PHONE',
        'supplier.phone' => 'PHONE',
        'SupplierTableMap::COL_PHONE' => 'PHONE',
        'COL_PHONE' => 'PHONE',
        'phone' => 'PHONE',
        'supplier.phone' => 'PHONE',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(SupplierTableMap::COL_ID);
            $criteria->removeSelectColumn(SupplierTableMap::COL_NAME);
            $criteria->removeSelectColumn(SupplierTableMap::COL_ADDRESS);
            $criteria->removeSelectColumn(SupplierTableMap::COL_PHONE);
        } else {
